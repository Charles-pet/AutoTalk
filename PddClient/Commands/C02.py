...
def Taboo(self, event=None):
    ...
    pyautogui.click(TextSendXY)
    str2='（1）禁止喂食人吃的食物，盐份过高，调味过重，会增加鼠儿身体负担。'
    pyperclip.copy(str2)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str3='（2）禁止直接接触太阳，鼠儿们非常怕热，夏天到了，请使用散热片或大理石为他们消暑。'
    pyperclip.copy(str3)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str5='（4）请了解自家鼠儿品种，独居鼠儿或不同品种禁止合笼饲养。'
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str6='（5）若无心理准备或是经济能力，请勿将母鼠、公鼠合笼饲养，鼠儿繁殖能力非常可观。'
    pyperclip.copy(str6)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str7='（6）禁止使用来路不明的饲料，生虫或发霉请丢弃，不要喂食！'
    pyperclip.copy(str7)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str8='（7）禁止让鼠儿们饮用生水，请让他们喝煮沸过的冷开水。'
    pyperclip.copy(str8)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str9='（8）禁止使用竹筷、棒冰棍等东西让鼠儿们磨牙，请使用市面上鼠儿专用的磨牙用品、饲料。'
    pyperclip.copy(str9)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str10='（9）禁止使用报纸、面纸等做垫材。报纸油墨过多，面纸内含有漂白剂。'
    ...
    pyautogui.click(TextSendXY)
    str11='（10）禁止将鼠儿养在过小的空间，空间至少要有滚轮，水瓶、食盆、小窝等用品。'
