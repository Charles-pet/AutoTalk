...
def Teething_sticks(self, event=None):
    #插入第一张图片   
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBanga.jpg'
    ...
    #插入第二张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBangb.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第三张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBangc.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第四张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBangd.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第五张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBange.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第六张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBangf.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str6='◆有时候看到小宠在咬笼子或者咬窝，不一定是需要磨牙，它是在玩耍。'
    pyperclip.copy(str6)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    #插入第七张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBangg.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    # 插入第八张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MoYaBang\MoYaBangh.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str9='◆我家的苜蓿草、提摩西草不仅是兔子、荷兰猪、龙猫的纯正草粮，健康安全。仓鼠、金丝熊也可以吃，纯草粮，改善肠胃功能。磨牙效果也很好，也叫磨牙草、润肠草。☺'
    pyperclip.copy(str9)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
