...
def Sick_rabbits(self, event=None):
    pyautogui.click(TextSendXY)
    str1='首先,如果是正规网上买的 收到货 包活2周'
    pyperclip.copy(str1)
    ...
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\BingTu\BingTu.jpg'
    ...
    pyautogui.click(TextSendXY)
    str4='球虫病发作症状:头向后仰、四肢伸长、死前抽搐尖叫\n发病就是一天就没了,前一天看起来都好好的\n最好是买3个月以上大的\n1-3个月大的兔子 成活率50%\n3个月以上的 基本上都没事.'
    pyperclip.copy(str4)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
