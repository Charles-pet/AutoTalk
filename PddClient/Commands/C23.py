...
def Grass_cakes(self, event=None):
    ...
    pyautogui.click(TextSendXY)
    str4='◆3.把香蕉泥和草粉充分混合，手捏或者用模具都行，可以是你喜欢的任意形象。（薄一点干的快）'
    pyperclip.copy(str4)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str5='◆4.烘箱干燥，建议温度80-90度，40-60分钟；太阳底下晒干1-2天。'
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str6='◆5.没有烘箱，捏成型的草饼，直接在太阳底下晒几天也可以。'
    pyperclip.copy(str6)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\CaoBing\CaoBing1.jpg'
    ...
    #插入第二张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\CaoBing\CaoBing2.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第三张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\CaoBing\CaoBing3.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第四张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\CaoBing\CaoBing4.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第五张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\CaoBing\CaoBing5.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第六张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\CaoBing\CaoBing6.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str8='◆亲，针对网络流传的比较有名的谣言:\n宠物不能吃香蕉，会受到辐射的问题，\n在物理学界有个专门的名词，叫“香蕉等效剂量”，'
    pyperclip.copy(str8)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str9='◆每吃一根香蕉，就受到约 0.1 微西弗的辐射。\n想要达到致死剂量，\n需要2西弗的辐射，也就是需要一次性吃下2~3万根香蕉。'
    pyperclip.copy(str9)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
