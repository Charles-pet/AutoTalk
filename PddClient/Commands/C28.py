...
def Alpaca():    #28
    ...
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    #插入第一张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\MuXuCao\01.png'
    ...
    time.sleep (1)
    #插入第二张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\MuXuCao\02.png'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    time.sleep (1)
    #插入第三张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\MuXuCao\03.png'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    time.sleep (1)
    #插入第四张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\MuXuCao\04.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第五张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\MuXuCao\05.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    time.sleep (1)
    #插入第六张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\MuXuCao\06.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str3='◆适合驼羊、牛、羊、鸵鸟、长颈鹿、赛马、龙猫、陆龟吃，主要是大型动物园和大型养殖户购买'
    pyperclip.copy(str3)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str4='◆特点是高蛋白、高营养，长肉快，绿色安全，不含转基因。经过机器2次压缩，叶子杆子都压碎了，再经过机器揉丝，适口性、消化吸收率都特别好。'
    pyperclip.copy(str4)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str5='◆每批货物进口都有美国木康实验室检测合格证书，美国农业部认证放行，中国海关检验合格放行。'
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str5='◆我家的苜蓿草指标:蛋白质20%以上，RFV180以上（饲料值），这个指标的意义是，营养高，消化吸收率高。是全球顶级牧草。'
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str5='◆一般国产的苜蓿草指标:蛋白质13%以上，RFV70以上（饲料值），动物的肠胃大小是不变的，每天只能吃固定的重量，营养低，吃了消化吸收不了多少，吃草都浪费了，浪费的都是钱啊。'
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str6='◆羊驼，每天给它们喂2次主食，主要吃苜蓿草，大的5斤、小的3斤。可以大幅提高羊驼的身体发育和毛发高质量生长。'
    pyperclip.copy(str6)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str6='◆可以提高奶牛、奶山羊的日均产奶量。赛马吃了特级苜蓿草，同等食量下，体力更加充沛。'
    pyperclip.copy(str6)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str6='◆100斤 / 310元， 包邮。 塑料编织袋包装。因为是发的快递，三天到，这样包装搬运比较方便。'
    pyperclip.copy(str6)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
