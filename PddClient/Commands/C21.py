...
def Mix_grass_pellets(self, event=None):
    ...
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    #插入第一张图片
    filepath = r'C:\AutoTalk\PddClient\MiBookAir\Picture\TimothyGranules\TimothyGranules.jpg'
    ...
    pyautogui.click(TextSendXY)
    str1='◆亲  我家的混和草颗粒营养兔粮，适合所有的兔子（幼兔、成年兔子）吃。'
    pyperclip.copy(str1)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str3='◆苜蓿草蛋白质高，毛发光亮，提摩西草草酸最低，改善肠胃功能，燕麦草比较甜，适口性好。综合营养草颗粒，营养成分足够宠物的日常生活需要。'
    pyperclip.copy(str3)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str4='◆吃这个草颗粒，=同时买了:美国特级苜蓿草、加拿大优质提摩西草、澳洲黄金燕麦草。'
    pyperclip.copy(str4)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str5='◆颗粒的加工温度70度，草里面的寄生虫和虫卵都杀死了，纤维也发生了有益的变化，更容易消化吸收。'
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter')
    time.sleep (0.3)
