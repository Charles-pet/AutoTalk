...
def Rabbit_rope(self, event=None):
    #插入第一张图片   
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\QianYinSheng\QianYinShenga.jpg'
    ...
    #插入第二张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\QianYinSheng\QianYinShengb.png'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第三张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\QianYinSheng\QianYinShengc.png'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str1='◆兔子、荷兰猪听话温顺的宠物:套在脖子和两个前腿之间。'
    pyperclip.copy(str1)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    str2='◆也可以直接套在脖子上，一般是非常调皮完全不配合带绳套的宠物。和短腿小体型宠物。'
    pyperclip.copy(str2)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    #插入第四张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\QianYinSheng\QianYinShengd.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第五张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\QianYinSheng\QianYinShenge.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str4='◆是松紧可以调节，扣子不要收的过紧，要注意观察宠物的反应，舒服就行。'
    pyperclip.copy(str4)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
    ...
    pyautogui.click(TextSendXY)
    #插入第六张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\QianYinSheng\QianYinShengf.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
