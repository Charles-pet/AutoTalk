...
def Sawdust(self, event=None):
    ...
    def send_to_clipboard(clip_type, data):
        ...
        time.sleep (0.5)
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MuXie\MuXiea.jpg'
    ...
    #插入第二张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MuXie\MuXieb.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str4="◆仓鼠会在木屑里面拉粑粑、尿尿，一般2周换一次就可以保证卫生。"
    pyperclip.copy(str4)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
    ...
    #插入第三张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MuXie\MuXiec.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    #插入第四张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MuXie\MuXied.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
    ...
    pyautogui.click(TextSendXY)
    str5= "◆一般木屑铺在笼子底部，比仓鼠高就可以，方便仓鼠钻在里面。"
    pyperclip.copy(str5)
    pyautogui.hotkey('ctrl','v')
    pyautogui.press('enter') 
    time.sleep (0.3)
    ...
    #插入第五张图片
    filepath = r'C:\autotalk\PddClient\MiBookAir\Picture\MuXie\MuXiee.jpg'
    image = Image.open(filepath)
    output = BytesIO()
    image.convert("RGB").save(output, "BMP")
    data = output.getvalue()[14:]
